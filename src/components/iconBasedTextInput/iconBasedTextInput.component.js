...
export type IconBasedTextInputProps = {
  ...
  forgetPasswordButtonPress?: ?(any) => void,
  textInputContainerStyle?: any,
};

export type IconBasedTextInputState = {};

class IconBasedTextInput extends PureComponent<IconBasedTextInputProps,
  IconBasedTextInputState,
  > {
  static defaultProps = {
  ...
  render() {
    return (
      <View style={componentStyle.mainContainer}>
        {!!this.props.title ? (
          <View style={componentStyle.titleMainContainer}>
            ...
            {!!this.props.forgetPassword ? (
              <TouchableOpacity
                style={componentStyle.infoIconButtonStyle}
                onPress={this.props.forgetPasswordButtonPress}>
                <LightText
                  style={{color: commonTheme.COLOR_SECONDARY, fontSize: 12}}>
                  {this.props.forgetPassword}
                </LightText>
              </TouchableOpacity>
            ) : null}
        ...
        <View
          style={[
            componentStyle.contentContainer,
